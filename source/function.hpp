...
/// Generate function argument list with types separated by comma and with only
/// arguments names name_arguments - if arguments should be named: a1, a2, ...
...
/// Generate function pointer type string for given function. Example void
/// (*)(int, doule)_ or  void (ClassName::*)(int, doule)_ for memeber function
...
/// including template specialization if any
...
// (aaaa::A::*)(int) ) &aaaa::A::foo, "doc") If function have default arguments
...
public:
  ...
  /// return Clang AST NamedDecl pointer to original declaration used to create
  /// this Binder
