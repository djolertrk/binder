...
/// @brief  Various functionality for handline clang::QualType and
/// clang::NamedDecl
...
/// build-in's)
void add_relevant_include_for_decl(clang::NamedDecl const *decl,
                                   IncludeSet &includes);
...
/// Attempt to simplify std:: name by removing unneeded template arguments,
/// assuming that there is no 'std::' namespaces prefix at the beginning of the
/// argument string
